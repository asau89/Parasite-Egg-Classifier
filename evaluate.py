"""
evaluate.py — Evaluation script for the trained ConvNeXt parasite classifier.
...
def evaluate(cfg: Config, checkpoint_path: str) -> None:
    ...
    sns.heatmap(
        ...
        yticklabels=[c.replace("_", " ") for c in cfg.classes],
        ax=ax,
    )
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate ConvNeXt parasite classifier")
    parser.add_argument(
